 ...
 */
export async function getDistanceMatrix(locations, apiKey, sources = null, destinations = null) {
  try {
 ...
 */
export async function getDistance(start, end, apiKey) {
  const result = await getDistanceMatrix([start, end], apiKey, [0], [1]);
